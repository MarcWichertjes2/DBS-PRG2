...
INSERT INTO `spelers` VALUES (1,1,10,'Liam','Jansen'),(2,1,10,'Ema','Vermeer'),(3,2,9,'Noah','De Vries'),(4,2,4,'Sophie','Bakker'),(5,3,11,'Daan','Peeters'),(6,3,6,'Mila','Hendriks'),(7,4,8,'Finn','Vos'),(8,4,5,'stinky','Kuipers'),(9,5,3,'Ties','Van Dijk'),(10,5,1,'Isa','De Boer'),(11,3,10,'Marc','Wichertjes');
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `spelers_AFTER_INSERT` AFTER INSERT ON `spelers` FOR EACH ROW BEGIN
    ...
    VALUES (NEW.ID, NEW.TeamsID, NEW.Nummer, NEW.Voornaam, NEW.Achternaam, current_user());
END */;;
DELIMITER ;
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `spelers_AFTER_DELETE` AFTER DELETE ON `spelers` FOR EACH ROW BEGIN
  ...
  VALUES (OLD.ID, OLD.TeamsID, OLD.Nummer, OLD.Voornaam, OLD.Achternaam, current_user());
...
INSERT INTO `spelers_delete_log` VALUES (1,12,10,120,'Pieter','Post','2025-06-05 09:45:12',NULL);
...
INSERT INTO `spelers_log` VALUES (1,11,3,10,'Marc','Wichertjes','2025-06-05 07:26:26',NULL),(2,12,10,120,'Pieter','Post','2025-06-05 07:32:24',NULL);
...
INSERT INTO `spelers_update_log` VALUES (1,2,1,1,7,10,'Emma','Emma','Vermeer','Vermeer','2025-06-05 09:48:15',NULL),(2,2,1,1,10,10,'Emma','Ema','Vermeer','Vermeer','2025-06-05 09:52:25',NULL),(3,8,4,4,5,5,'Lotte','stinky','Kuipers','Kuipers','2025-06-06 09:44:16','root@localhost');
...
-- Dump completed on 2025-06-06  9:45:49
